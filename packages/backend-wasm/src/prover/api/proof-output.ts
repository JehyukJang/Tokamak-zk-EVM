...
export async function createVerifierProofArtifactFromProverOutput(
  ...
  const g1Points: Readonly<Record<string, Uint8Array>> = {
    "proof0.U": initialCommitments.U, "proof0.V": initialCommitments.V, "proof0.W": initialCommitments.W,
    "binding.O_mid": binding.O_mid, "binding.O_prv": binding.O_prv,
    "proof0.Q_AX": initialCommitments.Q_AX, "proof0.Q_AY": initialCommitments.Q_AY,
    "proof2.Q_CX": copyCommitments.Q_CX, "proof2.Q_CY": copyCommitments.Q_CY,
    "proof4.Pi_X": openingCommitments.Pi_X, "proof4.Pi_Y": openingCommitments.Pi_Y,
    "proof0.B": initialCommitments.B, "proof1.R": recursionCommitment.R,
    "proof4.M_Y": openingCommitments.M_Y, "proof4.M_X": openingCommitments.M_X,
    "proof4.N_Y": openingCommitments.N_Y, "proof4.N_X": openingCommitments.N_X,
    "binding.O_pub_free": binding.O_pub_free, "binding.A_free": binding.A_free,
  };
  const evaluationsByName: Readonly<Record<string, Uint8Array>> = {
    "proof3.R_eval": evaluations.R_eval, "proof3.R_omegaX_eval": evaluations.R_omegaX_eval,
    "proof3.R_omegaX_omegaY_eval": evaluations.R_omegaX_omegaY_eval, "proof3.V_eval": evaluations.V_eval,
  };

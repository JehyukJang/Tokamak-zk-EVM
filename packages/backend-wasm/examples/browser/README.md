...
the npm package. Obtain a compatible `combined_sigma.rkyv` from the
[published CRS release](https://drive.google.com/drive/folders/14xqCbLoyoVmUVTTlopiXtKnoHPBGL-Sv),
authenticate its provenance, and keep transaction artifacts from one
synthesis.

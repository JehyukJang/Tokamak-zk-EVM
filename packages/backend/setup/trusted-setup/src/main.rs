...
struct Config {
    ...
    /// Synthesizer output directory required by testing-mode builds
    #[cfg(feature = "testing-mode")]
    #[arg(long, value_name = "PATH")]
    synthesizer_stat: String,

    /// Final setup artifact directory
    #[arg(long, value_name = "PATH")]
    output: String,

    /// Use the hardcoded testing tau and generators instead of random sampling

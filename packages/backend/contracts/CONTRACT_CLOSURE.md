...
| Subcircuit-library input origin | `contracts/input-origin-contract.json`           | `contracts/rust/input_origin.rs`; build selection `build-support/subcircuit_library/source_selection.rs`; serde ingress `libs/src/input_origin_serde.rs`                                                    | CRS provenance validator's origin type; copied CLI and backend-wasm provenance validators                                                         | `contracts/input-origin-contract.json`; provenance fixtures; backend and MPC setup documentation |

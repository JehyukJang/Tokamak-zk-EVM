...
| ------------------------------- | --------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- |
| CRS provenance                  | `common/contracts/crs-provenance-contract.json`                       | `rust/libs/src/crs_provenance.rs`; final MPC writer `rust/setup/mpc-setup/src/flows/phase2_gen_files.rs`; algorithm ingress `rust/libs/src/subcircuit_library.rs`; publisher ingress `rust/setup/mpc-setup/src/drive_upload.rs` | `common/contracts/typescript/crs-provenance-validator.ts`; copied to CLI `src/runtime/setup.ts` and backend-wasm `src/artifacts/binary/compatibility.ts` | `common/contracts/fixtures/final-mpc-crs-provenance*.json`; `README.md`; `rust/setup/mpc-setup/README.md` |

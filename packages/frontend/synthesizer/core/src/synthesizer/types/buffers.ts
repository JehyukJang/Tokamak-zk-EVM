...
__setDataPtType('SSTORE_ADDRESS', UINT160_DATA_PT_TYPE)
...
__setDataPtType('SLOAD_ADDRESS', UINT160_DATA_PT_TYPE)
...
__setDataPtType('ADDRESS_MASK', UINT256_DATA_PT_TYPE)

VARIABLE_DESCRIPTION_INCOMPLETE.BYTE_MASK.extSource = `Masker for one-byte EVM values`;
__setDataPtType('BYTE_MASK', UINT256_DATA_PT_TYPE)

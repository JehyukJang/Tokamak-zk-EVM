...
## Opcode categories
- **Arithmetic / Bitwise**: ADD, MUL, SUB, DIV/SDIV, MOD/SMOD, ADDMOD, MULMOD, EXP, SIGNEXTEND, LT/GT/SLT/SGT, EQ, ISZERO, AND/OR/XOR/NOT, BYTE, SHL/SHR/SAR, KECCAK256 (mapped to Poseidon). Handled in `handleArith` through `ArithmeticManager.placeArithComposition`; Jubjub exponentiation remains a temporary separate path.

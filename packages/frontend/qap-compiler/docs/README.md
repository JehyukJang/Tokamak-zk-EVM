...
Background, integration, and maintainer references behind the
[consumer README](../README.md). Readers new to Tokamak zk-EVM should start
with the circuit implementation reference.
...
| Understand the circuits and their composition | [Circuit implementation reference](./circuit-implementation-reference.md) |

...
const main = async () => {
  ...
  for (const [signalName, label] of [
    ...
    ["main.reference.responseScalar.result[0]", "response terminal X coordinate"],
    ["main.reference.responseScalar.result[1]", "response terminal Y coordinate"],
    ["main.reference.responseScalar.result[2]", "response terminal Z coordinate"],
    ["main.reference.responseScalar.result[3]", "response terminal T coordinate"],
    ["main.reference.terminalAddition.result[0]", "sum terminal X coordinate"],
    ["main.reference.terminalAddition.result[1]", "sum terminal Y coordinate"],
    ["main.reference.terminalAddition.result[2]", "sum terminal Z coordinate"],

...
const App = () => {
    ...
    return (_jsxs("div", { style: { padding: '20px' }, children: [_jsx("h1", { children: "Synthesizer Developer Playground" }), _jsx("input", { type: "text", value: transactionId, onChange: (e) => setTransactionId(e.target.value), placeholder: "Enter Transaction ID", style: {
                    padding: '10px',
                    width: '300px',
                    marginRight: '10px',
                    ...
                    borderRadius: '4px',
                    cursor: 'pointer',
                }, children: "Process" }), _jsxs("div", { style: { marginTop: '20px' }, children: [status && _jsx("p", { children: status }), serverData?.permutation && (_jsx("button", { onClick: () => handleDownload(serverData.permutation, 'permutation.ts'), style: {
                            padding: '10px 20px',
                            background: '#28a745',
                            color: 'white',
                            border: 'none',
                            ...
                            cursor: 'pointer',
                            marginRight: '10px',
                        }, children: "Download Permutation" })), serverData?.placementInstance && (_jsx("button", { onClick: () => handleDownload(serverData.placementInstance, 'placementInstance.ts'), style: {
                            padding: '10px 20px',
                            background: '#17a2b8',
                            color: 'white',
                            border: 'none',
                            borderRadius: '4px',
                            cursor: 'pointer',
                        }, children: "Download Placement Instance" }))] })] }));
};
export default App;
